...
Implementacao e validacao local concluidas. A confirmacao de deploy e o smoke
autenticado de producao devem ser registrados depois que backend e web estiverem
`Live` no mesmo commit.
