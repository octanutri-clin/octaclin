...
for (const risco of ['Isolamento multi-tenant', 'Autenticacao e autorizacao', 'Integracoes externas', 'BFF e sessao', 'Sessoes e rotacao de refresh token', 'Trilha de auditoria e redacao de metadados', 'Alerta e resposta a incidente de auditoria', 'Aplicacao de migration fora de banda', 'Origem do backend no BFF', 'Agrupamento de atualizacao de dependencia', 'Coerencia da versao do Node']) {
