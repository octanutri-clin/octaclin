...
Ambiente local (backend `http://localhost:3001` + web `http://localhost:3000`) no ar apontando para o banco de staging. Testes manuais em andamento: BUG-003 e BUG-004 foram encontrados e corrigidos nesta mesma sessao. Falta continuar as jornadas manuais listadas acima, definir participantes internos por perfil, e preencher a tabela de participantes e a decisao de aceite.

Lacunas conhecidas que ficam para uma proxima rodada (mesmo padrao do BUG-004, ainda nao auditado):
- Modulos de comunicacoes, materiais e questionarios podem ter a mesma falta de escopo por profissional responsavel.
- Formularios de criacao de paciente/circulo/desafio no frontend ainda mostram o seletor de profissional para o papel Professional (o backend ja ignora o valor e forca o proprio profissional, mas a UI deveria esconder o campo por clareza).
