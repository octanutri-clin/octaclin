...
Ambiente local (backend `http://localhost:3001` + web `http://localhost:3000`) no ar apontando para o banco de staging. Testes manuais em andamento: BUG-003, BUG-004 e BUG-004b foram encontrados e corrigidos nesta mesma sessao. Falta continuar as jornadas manuais listadas acima, definir participantes internos por perfil, e preencher a tabela de participantes e a decisao de aceite.

Lacunas conhecidas que ficam para uma proxima rodada (mesmo padrao do BUG-004/BUG-004b, ainda nao auditado):
