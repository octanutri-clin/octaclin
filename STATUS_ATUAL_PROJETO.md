...
- Fase 253 implementada e validada localmente: a agenda interna ganhou trava
  ...
  O preflight da funcao publica segura passou no banco de integracao. O rollout
  continua pendente da migration aditiva `1720000001034` em producao; o PR nao
  deve ser integrado antes dessa expansao de schema. Depois do rollout, a
  proxima fase e a 254.
