...
// da clinica), mesma decisao ja tomada para modelos de plano alimentar
// (Fase 269): a rota vive fora de `/pacientes/[id]`.
export async function executarProxyModelosEvolucao(
  caminho: string,
