 ...
 * prontuario. Rota distinta de arquivar e de
 * lgpd/solicitacao-eliminacao. Ver ServicoPacientes.desativarContaAcesso
 * no backend.
 */
export async function PATCH(_request: NextRequest, props: Params) {
  ...
  try {
    ...
    const resposta = await requisitarBackendAutenticado(`/pacientes/${encodeURIComponent(id)}/conta-acesso/desativacao`, {
      method: 'PATCH'
    });
