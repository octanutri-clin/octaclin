...
const pastaTemporaria = mkdtempSync(join(tmpdir(), 'octaclin-prontuario-timeline-bff-'));
...
executar(process.execPath, ['--test', join(pastaTemporaria, 'scripts', 'prontuario-timeline-bff.spec.js')], pastaTemporaria);
rmSync(pastaTemporaria, { recursive: true, force: true });
