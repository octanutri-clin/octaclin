...
const pastaTemporaria = mkdtempSync(join(tmpdir(), 'octaclin-override-prioridade-acompanhamento-bff-'));
...
executar(process.execPath, ['--test', join(pastaTemporaria, 'scripts', 'override-prioridade-acompanhamento-bff.spec.js')], pastaTemporaria);
rmSync(pastaTemporaria, { recursive: true, force: true });
