...
export function IntegracoesApiCliente() {
  ...
  const carregar = useCallback(async () => {
    ...
    try {
      ...
      setErro(erroAtual instanceof Error ? erroAtual.message : 'Falha ao carregar integracoes.');
    } finally {
      setCarregando(false);
    }
  }, []);
  ...
  async function confirmar() {
    ...
    try {
      ...
      setErro(erroAtual instanceof Error ? erroAtual.message : 'Falha ao concluir acao.');
    } finally {
      setProcessando(null);
    }
  }
