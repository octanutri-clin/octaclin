...
const tipos: Array<{ id: TipoCondutaTerapeuticaApi; rotulo: string }> = [
  ...
  { id: 'produto', rotulo: 'Produto' }, { id: 'formula_manipulada', rotulo: 'Formula manipulada' }
];
